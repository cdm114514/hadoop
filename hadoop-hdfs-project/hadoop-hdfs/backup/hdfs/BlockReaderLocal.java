...
class BlockReaderLocal implements BlockReader
{
    ...
    public static class Builder
    {
        ...
        {
            long readahead = cachingStrategy.getReadahead() != null ? cachingStrategy.getReadahead() : DFSConfigKeys.DFS_DATANODE_READAHEAD_BYTES_DEFAULT;
    ...
    public synchronized int read(ByteBuffer buf) throws IOException
    {
        ...
        try
        {
            ...
            {
                traceString = new StringBuilder().append("read(").append("buf.remaining=").append(buf.remaining()).append(", block=").append(block).append(", filename=").append(filename).append(", canSkipChecksum=").append(canSkipChecksum).append(")").toString();
    ...
    public synchronized int read(byte[] arr, int off, int len) throws IOException
    {
        ...
        try
        {
            ...
            if (LOG.isTraceEnabled())
            {
                traceString = new StringBuilder().append("read(arr.length=").append(arr.length).append(", off=").append(off).append(", len=").append(len).append(", filename=").append(filename).append(", block=").append(block).append(", canSkipChecksum=").append(canSkipChecksum).append(")").toString();
    ...
    public synchronized long skip(long n) throws IOException
    {
        ...
        if (LOG.isTraceEnabled())
        {
            LOG.trace("skip(n=" + n + ", block=" + block + ", filename=" + filename + "): discarded " + discardedFromBuf + " bytes from " + "dataBuf and advanced dataPos by " + remaining);
        }
        dataPos += remaining;
        return n;
    }
