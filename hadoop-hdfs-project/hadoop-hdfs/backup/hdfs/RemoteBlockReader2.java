...
public class RemoteBlockReader2 implements BlockReader
{
    ...
    public synchronized int read(byte[] buf, int off, int len) throws IOException
    {
        ...
        {
            TraceScope scope = Trace.startSpan("RemoteBlockReader2#readNextPacket(" + blockId + ")", Sampler.NEVER);
            try
            {
                readNextPacket();
            } finally
    ...
    static void checkSuccess(BlockOpResponseProto status, Peer peer, ExtendedBlock block, String file) throws IOException
    {
