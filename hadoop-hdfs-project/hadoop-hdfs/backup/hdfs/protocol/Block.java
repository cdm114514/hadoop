...
public class Block implements Writable, Comparable<Block>
{
    ...
    public static final Pattern metaFilePattern = Pattern.compile(BLOCK_FILE_PREFIX + "(-??\\d++)_(\\d++)\\" + METADATA_EXTENSION + "$");
    public static final Pattern metaOrBlockFilePattern = Pattern.compile(BLOCK_FILE_PREFIX + "(-??\\d++)(_(\\d++)\\" + METADATA_EXTENSION + ")?$");
    ...
    public static long getGenerationStamp(String metaFile)
    {
        ...
        return m.matches() ? Long.parseLong(m.group(2)) : GenerationStamp.GRANDFATHER_GENERATION_STAMP;
    }
