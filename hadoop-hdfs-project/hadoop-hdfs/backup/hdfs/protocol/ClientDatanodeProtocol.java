...
public interface ClientDatanodeProtocol
{
     ...
     * @param blockIds    list of blocks on the local datanode
     * @param tokens      block access tokens corresponding to the requested blocks
     * @return an HdfsBlocksMetadata that associates {@link ExtendedBlock}s with
     * data directories
     * @throws IOException if datanode is unreachable, or replica is not found on datanode
     */
