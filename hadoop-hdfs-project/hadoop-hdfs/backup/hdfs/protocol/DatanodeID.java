...
public class DatanodeID implements Comparable<DatanodeID>
{
    ...
    {
        this(from.getIpAddr(), from.getHostName(), datanodeUuid, from.getXferPort(), from.getInfoPort(), from.getInfoSecurePort(), from.getIpcPort());
    ...
    public boolean equals(Object to)
    {
        ...
        return (getXferAddr().equals(((DatanodeID) to).getXferAddr()) && datanodeUuid.equals(((DatanodeID) to).getDatanodeUuid()));
    }
