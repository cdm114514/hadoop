...
public class HdfsBlocksMetadata
{
     ...
     *
     * @param blockIds      List of blocks described
     * @param volumeIds     List of potential volume identifiers, specifying volumes where
     *                      blocks may be stored
     * @param volumeIndexes Indexes into the list of volume identifiers, one per block
     */
    ...
    {
        return "Metadata for " + blockIds.length + " blocks in " + blockPoolId + ": " + Joiner.on(",").join(Longs.asList(blockIds));
    }
}
