...
public class TrustedChannelResolver implements Configurable
{
    ...
    {
        Class<? extends TrustedChannelResolver> clazz = conf.getClass(DFSConfigKeys.DFS_TRUSTEDCHANNEL_RESOLVER_CLASS, TrustedChannelResolver.class, TrustedChannelResolver.class);
