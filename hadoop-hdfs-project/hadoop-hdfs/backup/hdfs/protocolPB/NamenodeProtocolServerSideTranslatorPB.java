...
public class NamenodeProtocolServerSideTranslatorPB implements NamenodeProtocolPB
{
    ...
    private final static ErrorReportResponseProto VOID_ERROR_REPORT_RESPONSE = ErrorReportResponseProto.newBuilder().build();

    private final static EndCheckpointResponseProto VOID_END_CHECKPOINT_RESPONSE = EndCheckpointResponseProto.newBuilder().build();
    ...
    @Override
    public GetTransactionIdResponseProto getTransactionId(RpcController unused, GetTransactionIdRequestProto request) throws ServiceException
    {
        long txid;
        try
        {
    ...
    @Override
    public GetMostRecentCheckpointTxIdResponseProto getMostRecentCheckpointTxId(RpcController unused, GetMostRecentCheckpointTxIdRequestProto request) throws ServiceException
    {
        long txid;
        try
        {
    ...
    @Override
    public RollEditLogResponseProto rollEditLog(RpcController unused, RollEditLogRequestProto request) throws ServiceException
    {
    ...
    @Override
    public ErrorReportResponseProto errorReport(RpcController unused, ErrorReportRequestProto request) throws ServiceException
    {
        try
        {
    ...
    @Override
    public RegisterResponseProto registerSubordinateNamenode(RpcController unused, RegisterRequestProto request) throws ServiceException
    {
    ...
    @Override
    public StartCheckpointResponseProto startCheckpoint(RpcController unused, StartCheckpointRequestProto request) throws ServiceException
    {
        NamenodeCommand cmd;
        try
        {
    ...
    @Override
    public EndCheckpointResponseProto endCheckpoint(RpcController unused, EndCheckpointRequestProto request) throws ServiceException
    {
        try
        {
    ...
    @Override
    public GetEditLogManifestResponseProto getEditLogManifest(RpcController unused, GetEditLogManifestRequestProto request) throws ServiceException
    {
    ...
    @Override
    public VersionResponseProto versionRequest(RpcController controller, VersionRequestProto request) throws ServiceException
    {
        NamespaceInfo info;
        try
        {
    ...
    @Override
    public IsUpgradeFinalizedResponseProto isUpgradeFinalized(RpcController controller, IsUpgradeFinalizedRequestProto request) throws ServiceException
    {
