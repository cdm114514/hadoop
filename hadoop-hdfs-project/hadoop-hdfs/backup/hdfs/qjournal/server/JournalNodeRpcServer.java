...
class JournalNodeRpcServer implements QJournalProtocol
{
    ...
    {
        String addr = conf.get(DFSConfigKeys.DFS_JOURNALNODE_RPC_ADDRESS_KEY, DFSConfigKeys.DFS_JOURNALNODE_RPC_ADDRESS_DEFAULT);
    ...
    public GetJournalStateResponseProto getJournalState(String journalId) throws IOException
    {
        ...
        return GetJournalStateResponseProto.newBuilder().setLastPromisedEpoch(epoch).setHttpPort(jn.getBoundHttpAddress().getPort()).setFromURL(jn.getHttpServerURI()).build();
    }
