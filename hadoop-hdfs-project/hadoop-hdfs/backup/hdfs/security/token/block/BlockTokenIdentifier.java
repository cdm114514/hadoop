...
public class BlockTokenIdentifier extends TokenIdentifier
{
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj instanceof BlockTokenIdentifier)
        {
            ...
            return this.expiryDate == that.expiryDate && this.keyId == that.keyId && isEqual(this.userId, that.userId) && isEqual(this.blockPoolId, that.blockPoolId) && this.blockId == that.blockId && isEqual(this.modes, that.modes);
        }
        return false;
    }
    ...
    public int hashCode()
    {
        return (int) expiryDate ^ keyId ^ (int) blockId ^ modes.hashCode() ^ (userId == null ? 0 : userId.hashCode()) ^ (blockPoolId == null ? 0 : blockPoolId.hashCode());
    }
