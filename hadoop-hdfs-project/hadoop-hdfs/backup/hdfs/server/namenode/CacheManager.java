...
public final class CacheManager
{
    ...
    public static final class PersistState
    {
        ...
        public PersistState(CacheManagerSection section, List<CachePoolInfoProto> pools, List<CacheDirectiveInfoProto> directives)
        {
     ...
     * Only the superuser should be able to call this function.
     *
     * @param info The info for the cache pool to modify.
     */
     ...
     * Only the superuser should be able to call this function.
     *
     * @param poolName The name for the cache pool to remove.
     */
    ...
    public BatchedListEntries<CachePoolEntry> listCachePools(FSPermissionChecker pc, String prevKey)
    {
        assert namesystem.hasReadLock();
        final int NUM_PRE_ALLOCATED_ENTRIES = 16;
        ArrayList<CachePoolEntry> results = new ArrayList<CachePoolEntry>(NUM_PRE_ALLOCATED_ENTRIES);
    ...
    private void addCacheDirective(final String poolName, final CacheDirective directive) throws IOException
    {
        CachePool pool = cachePools.get(poolName);
        if (pool == null)
        {
