...
public enum Content
{
    ...
    private static final EnumCounters.Factory<Content, Counts> FACTORY = new EnumCounters.Factory<Content, Counts>()
    {
        @Override
     ...
     */
    public static class CountsMap extends EnumCounters.Map<CountsMap.Key, Content, Counts>
    {
        /**
