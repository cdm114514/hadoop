...
public abstract class FSEditLogOp
{
    ...
    {
        private final EnumMap<FSEditLogOpCodes, FSEditLogOp> inst = new EnumMap<FSEditLogOpCodes, FSEditLogOp>(FSEditLogOpCodes.class);
        ...
        public OpInstanceCache()
        {
            ...
            inst.put(OP_ROLLING_UPGRADE_START, new RollingUpgradeOp(OP_ROLLING_UPGRADE_START, "start"));
            inst.put(OP_ROLLING_UPGRADE_FINALIZE, new RollingUpgradeOp(OP_ROLLING_UPGRADE_FINALIZE, "finalize"));
    ...
    {
        return rpcClientId != RpcConstants.DUMMY_CLIENT_ID && rpcCallId != RpcConstants.INVALID_CALL_ID;
    }
    ...
    abstract void readFields(DataInputStream in, int logVersion) throws IOException;
    ...
    private static void writeRpcIds(final byte[] clientId, final int callId, DataOutputStream out) throws IOException
    {
    ...
    {
        this.rpcClientId = st.hasChildren("RPC_CLIENTID") ? ClientId.toBytes(st.getValue("RPC_CLIENTID")) : RpcConstants.DUMMY_CLIENT_ID;
        this.rpcCallId = st.hasChildren("RPC_CALLID") ? Integer.parseInt(st.getValue("RPC_CALLID")) : RpcConstants.INVALID_CALL_ID;
    }

    private static void appendRpcIdsToString(final StringBuilder builder, final byte[] clientId, final int callId)
    {
    ...
    private static void appendRpcIdsToXml(ContentHandler contentHandler, final byte[] clientId, final int callId) throws SAXException
    {
    ...
    static abstract class AddCloseOp extends FSEditLogOp implements BlockListUpdatingOp
    {
        ...
        <T extends AddCloseOp> T setBlocks(Block[] blocks)
        {
            ...
            {
                throw new RuntimeException("Can't have more than " + MAX_BLOCKS + " in an AddCloseOp.");
            }
            this.blocks = blocks;
            return (T) this;
        }
        ...
        protected void toXml(ContentHandler contentHandler) throws SAXException
        {
            ...
            XMLUtils.addSaxString(contentHandler, "OVERWRITE", Boolean.toString(overwrite));
            for (Block b : blocks)
            {
    ...
    static class AppendOp extends FSEditLogOp
    {
        ...
        protected void toXml(ContentHandler contentHandler) throws SAXException
        {
            ...
            XMLUtils.addSaxString(contentHandler, "CLIENT_NAME", clientName);
            XMLUtils.addSaxString(contentHandler, "CLIENT_MACHINE", clientMachine);
            XMLUtils.addSaxString(contentHandler, "NEWBLOCK", Boolean.toString(newBlock));
            appendRpcIdsToXml(contentHandler, rpcClientId, rpcCallId);
        }
    ...
    static class AddBlockOp extends FSEditLogOp
    {
        ...
        public String toString()
        {
            ...
            sb.append("AddBlockOp [path=").append(path).append(", penultimateBlock=").append(penultimateBlock == null ? "NULL" : penultimateBlock).append(", lastBlock=").append(lastBlock);
    ...
    static class UpdateBlocksOp extends FSEditLogOp implements BlockListUpdatingOp
    {
        ...
        {
            StringBuilder sb = new StringBuilder();
            sb.append("UpdateBlocksOp [path=").append(path).append(", blocks=").append(Arrays.toString(blocks));
            appendRpcIdsToString(sb, rpcClientId, rpcCallId);
            sb.append("]");
            return sb.toString();
        }
    ...
    static class ConcatDeleteOp extends FSEditLogOp
    {
        ...
        ConcatDeleteOp setSources(String[] srcs)
        {
            ...
            {
                throw new RuntimeException("ConcatDeleteOp can only have " + MAX_CONCAT_SRC + " sources at most.");
            }
            this.srcs = srcs;
    ...
    static class SetGenstampV2Op extends FSEditLogOp
    {
        ...
        protected void toXml(ContentHandler contentHandler) throws SAXException
        {
            XMLUtils.addSaxString(contentHandler, "GENSTAMPV2", Long.toString(genStampV2));
        }
    ...
    static class AllocateBlockIdOp extends FSEditLogOp
    {
        ...
        protected void toXml(ContentHandler contentHandler) throws SAXException
        {
            XMLUtils.addSaxString(contentHandler, "BLOCK_ID", Long.toString(blockId));
        }
    ...
    static class SetPermissionsOp extends FSEditLogOp
    {
        ...
        {
            XMLUtils.addSaxString(contentHandler, "SRC", src);
            XMLUtils.addSaxString(contentHandler, "MODE", Short.valueOf(permissions.toShort()).toString());
        }
    ...
    static class SetNSQuotaOp extends FSEditLogOp
    {
        ...
        {
            XMLUtils.addSaxString(contentHandler, "SRC", src);
            XMLUtils.addSaxString(contentHandler, "NSQUOTA", Long.toString(nsQuota));
        }
    ...
    static class SetQuotaOp extends FSEditLogOp
    {
        ...
        protected void toXml(ContentHandler contentHandler) throws SAXException
        {
            XMLUtils.addSaxString(contentHandler, "SRC", src);
            XMLUtils.addSaxString(contentHandler, "NSQUOTA", Long.toString(nsQuota));
            XMLUtils.addSaxString(contentHandler, "DSQUOTA", Long.toString(dsQuota));
        }
    ...
    static class SetQuotaByStorageTypeOp extends FSEditLogOp
    {
        ...
        {
            XMLUtils.addSaxString(contentHandler, "SRC", src);
            XMLUtils.addSaxString(contentHandler, "STORAGETYPE", Integer.toString(type.ordinal()));
            XMLUtils.addSaxString(contentHandler, "DSQUOTA", Long.toString(dsQuota));
        }
    ...
    static class TruncateOp extends FSEditLogOp
    {
        ...
        protected void toXml(ContentHandler contentHandler) throws SAXException
        {
            ...
            XMLUtils.addSaxString(contentHandler, "NEWLENGTH", Long.toString(newLength));
            XMLUtils.addSaxString(contentHandler, "TIMESTAMP", Long.toString(timestamp));
            if (truncateBlock != null)
            {
    ...
    static class GetDelegationTokenOp extends FSEditLogOp
    {
        ...
        protected void toXml(ContentHandler contentHandler) throws SAXException
        {
            ...
            XMLUtils.addSaxString(contentHandler, "EXPIRY_TIME", Long.toString(expiryTime));
        }

        @Override
        void fromXml(Stanza st) throws InvalidXmlException
        {
            this.token = delegationTokenFromXml(st.getChildren("DELEGATION_TOKEN_IDENTIFIER").get(0));
    ...
    static class UpdateMasterKeyOp extends FSEditLogOp
    {
        ...
        void fromXml(Stanza st) throws InvalidXmlException
        {
            this.key = delegationKeyFromXml(st.getChildren("DELEGATION_KEY").get(0));
        }
    }
    ...
    static class LogSegmentOp extends FSEditLogOp
    {
        ...
        {
            super(code);
            assert code == OP_START_LOG_SEGMENT || code == OP_END_LOG_SEGMENT : "Bad op: " + code;
        }
     ...
     */
    static class RollingUpgradeOp extends FSEditLogOp
    { // @Idempotent
        ...
        protected void toXml(ContentHandler contentHandler) throws SAXException
        {
            XMLUtils.addSaxString(contentHandler, name + "TIME", Long.toString(time));
        }
        ...
        public String toString()
        {
            return new StringBuilder().append("RollingUpgradeOp [").append(name).append(", time=").append(time).append("]").toString();
        }
    ...
    public static Block blockFromXml(Stanza st) throws InvalidXmlException
    {
