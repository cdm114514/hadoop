...
public class INodeMap
{
    ...
    public INode get(long id)
    {
        INode inode = new INodeWithAdditionalFields(id, null, new PermissionStatus("", "", new FsPermission((short) 0)), 0, 0)
        {
            ...
            @Override
            public void destroyAndCollectBlocks(BlockStoragePolicySuite bsps, BlocksMapUpdateInfo collectedBlocks, List<INode> removedINodes)
            {
                // Nothing to do
            }
            ...
            @Override
            public QuotaCounts cleanSubtree(BlockStoragePolicySuite bsps, int snapshotId, int priorSnapshotId, BlocksMapUpdateInfo collectedBlocks, List<INode> removedINodes)
            {
                return null;
            }
