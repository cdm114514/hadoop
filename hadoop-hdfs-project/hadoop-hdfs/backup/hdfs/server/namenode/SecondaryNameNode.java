...
public class SecondaryNameNode implements Runnable, SecondaryNameNodeInfoMXBean
{
    ...
    {
        return NetUtils.createSocketAddr(conf.getTrimmed(DFSConfigKeys.DFS_NAMENODE_SECONDARY_HTTP_ADDRESS_KEY, DFSConfigKeys.DFS_NAMENODE_SECONDARY_HTTP_ADDRESS_DEFAULT));
    }
    ...
    static class CommandLineOpts
    {
        ...
        CommandLineOpts()
        {
            ...
            checkpointOpt = OptionBuilder.withArgName("force").hasOptionalArg().withDescription("checkpoint on startup").create("checkpoint");
            ;
    ...
    static class CheckpointStorage extends FSImage
    {
        ...
        private static class CheckpointLogPurger implements LogsPurgeable
        {
            ...
            private final StoragePurger purger = new NNStorageRetentionManager.DeletionStoragePurger();
            ...
            public void selectInputStreams(Collection<EditLogInputStream> streams, long fromTxId, boolean inProgressOk)
            {
                ...
                while (iter.hasNext())
                {
                    ...
                    FileJournalManager.addStreamsToCollectionFromFiles(editFiles, streams, fromTxId, inProgressOk);
                }
            }
    ...
    static void doMerge(CheckpointSignature sig, RemoteEditLogManifest manifest, boolean loadImage, FSImage dstImage, FSNamesystem dstNamesystem) throws IOException
    {
