...
public class StreamFile extends DfsServlet
{
     ...
     */
    static void sendPartialData(FSDataInputStream in, OutputStream out, HttpServletResponse response, long contentLength, List<InclusiveByteRange> ranges) throws IOException
    {
    ...
    static void copyFromOffset(FSDataInputStream in, OutputStream out, long offset, long count) throws IOException
    {
        in.seek(offset);
