...
public class DirectorySnapshottableFeature extends DirectoryWithSnapshotFeature
{
     ...
     * Rename a snapshot
     *
     * @param path    The directory path where the snapshot was taken. Used for
     *                generating exception message.
     * @param oldName Old name of the snapshot
     * @param newName New name the snapshot will be renamed to
     * @throws SnapshotException Throw SnapshotException when either the snapshot with the old
     ...
     * Add a snapshot.
     */
    public Snapshot addSnapshot(INodeDirectory snapshotRoot, int id, String name) throws SnapshotException, QuotaExceededException
    {
     ...
     * exists.
     */
    public Snapshot removeSnapshot(BlockStoragePolicySuite bsps, INodeDirectory snapshotRoot, String snapshotName, BlocksMapUpdateInfo collectedBlocks, final List<INode> removedINodes) throws SnapshotException
    {
    ...
    public ContentSummaryComputationContext computeContentSummary(final BlockStoragePolicySuite bsps, final INodeDirectory snapshotRoot, final ContentSummaryComputationContext summary)
    {
     ...
     */
    SnapshotDiffInfo computeDiff(final INodeDirectory snapshotRoot, final String from, final String to) throws SnapshotException
    {
