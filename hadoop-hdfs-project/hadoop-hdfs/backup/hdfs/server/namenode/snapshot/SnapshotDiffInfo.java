...
class SnapshotDiffInfo
{
    ...
    static class RenameEntry
    {
        ...
        void setSource(INode source, byte[][] sourceParentPath)
        {
            ...
            System.arraycopy(sourceParentPath, 0, sourcePath, 0, sourceParentPath.length);
        ...
        void setTarget(INode target, byte[][] targetParentPath)
        {
            ...
            System.arraycopy(targetParentPath, 0, targetPath, 0, targetParentPath.length);
     ...
     */
    private final Map<INodeDirectory, ChildrenDiff> dirDiffMap = new HashMap<INodeDirectory, ChildrenDiff>();
