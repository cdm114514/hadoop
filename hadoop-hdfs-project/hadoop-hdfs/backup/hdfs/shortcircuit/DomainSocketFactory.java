...
public class DomainSocketFactory
{
    ...
    {
        UNUSABLE(false, false), SHORT_CIRCUIT_DISABLED(true, false), VALID(true, true);
    ...
    {
        private final static PathInfo NOT_CONFIGURED = new PathInfo("", PathState.UNUSABLE);
        ...
        {
            return new StringBuilder().append("PathInfo{path=").append(path).append(", state=").append(state).append("}").toString();
        }
    }
