...
public class ShortCircuitShm
{
     ...
     *
     * @return The slot.
     * @throws InvalidRequestException If the slot index we're trying to allocate has not been
     *                                 initialized, or is already in use.
     */
    synchronized public final Slot registerSlot(int slotIdx, ExtendedBlockId blockId) throws InvalidRequestException
    {
        if (slotIdx < 0)
        {
