...
public class AdminHelper
{
    ...
    {
        return new TableListing.Builder().addField("").addField("", true).wrapWidth(MAX_LINE_WIDTH).hideHeaders().build();
    }
    ...
    static class HelpCommand implements Command
    {
        ...
        public int run(Configuration conf, List<String> args) throws IOException
        {
            ...
            final AdminHelper.Command command = AdminHelper.determineCommand("-" + commandName, commands);
            if (command == null)
            {
