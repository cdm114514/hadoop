...
class DelimitedImageVisitor extends TextWriterImageVisitor
{
    ...
    private final AbstractMap<ImageElement, String> elements = new HashMap<ImageElement, String>();
    ...
    void leaveEnclosingElement() throws IOException
    {
        ...
        if (elem == ImageElement.INODE || elem == ImageElement.INODE_UNDER_CONSTRUCTION)
        {
            writeLine();
            write("\n");
            reset();
    ...
    void visitEnclosingElement(ImageElement element, ImageElement key, String value) throws IOException
    {
        ...
        if (key == ImageElement.NUM_BLOCKS && elements.containsKey(ImageElement.NUM_BLOCKS))
        {
