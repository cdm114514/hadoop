...
public final class PBImageXmlWriter
{
    ...
    {
        out.print("<ref>");
        o("referredId", r.getReferredId()).o("name", r.getName().toStringUtf8()).o("dstSnapshotId", r.getDstSnapshotId()).o("lastSnapshotId", r.getLastSnapshotId());
        out.print("</ref>\n");
    }
    ...
    {
        o("permission", dumpPermission(s.getPermission())).o("target", s.getTarget().toStringUtf8()).o("mtime", s.getModificationTime()).o("atime", s.getAccessTime());
    }
    ...
    private void dumpNameSection(InputStream in) throws IOException
    {
        ...
        o("genstampV1", s.getGenstampV1()).o("genstampV2", s.getGenstampV2()).o("genstampV1Limit", s.getGenstampV1Limit()).o("lastAllocatedBlockId", s.getLastAllocatedBlockId()).o("txid", s.getTransactionId());
        out.print("</NameSection>\n");
    }
