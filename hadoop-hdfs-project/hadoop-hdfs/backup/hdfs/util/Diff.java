...
public class Diff<K, E extends Diff.Element<K>>
{
     ...
     */
    protected static <K, E extends Comparable<K>> int search(final List<E> elements, final K name)
    {
    ...
    private static <K, E extends Diff.Element<K>> Container<E> accessPrevious(final K name, final List<E> clist, final List<E> dlist)
    {
    ...
    private static <K, E extends Diff.Element<K>> List<E> apply2Previous(final List<E> previous, final List<E> clist, final List<E> dlist)
    {
        // Assumptions:
     ...
     * @param deletedProcesser process the deleted/overwritten elements in case 2.1, 2.3, 3.1 and 3.3.
     */
    public void combinePosterior(final Diff<K, E> posterior, final Processor<E> deletedProcesser)
    {
