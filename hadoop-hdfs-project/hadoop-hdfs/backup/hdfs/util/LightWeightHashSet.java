...
public class LightWeightHashSet<T> implements Collection<T>
{
    ...
    /**
     * @param initCapacity  Recommended size of the internal array.
     * @param maxLoadFactor used to determine when to expand the internal array
     * @param minLoadFactor used to determine when to shrink the internal array
     */
    ...
    protected LinkedElement<T> removeElem(final T key)
    {
        ...
        {
            return null;
        } else if (hashCode == entries[index].hashCode && entries[index].element.equals(key))
        {
    ...
    public String toString()
    {
        ...
        b.append("(size=").append(size).append(", modification=").append(modification).append(", entries.length=").append(entries.length).append(")");
        return b.toString();
    }
    ...
    private class LinkedSetIterator implements Iterator<T>
    {
        ...
        public T next()
        {
            ...
            {
                throw new ConcurrentModificationException("modification=" + modification + " != startModification = " + startModification);
            }
            if (next == null)
            {
