...
public abstract class ByteRangeInputStream extends FSInputStream
{
    ...
    private static long getStreamLength(HttpURLConnection connection, Map<String, List<String>> headers) throws IOException
    {
    ...
    private static long getLengthFromRange(String cl) throws IOException
    {
        ...
        {
            throw new IOException("failed to get content length by parsing the content range: " + cl + " " + e.getMessage());
        }
    }
