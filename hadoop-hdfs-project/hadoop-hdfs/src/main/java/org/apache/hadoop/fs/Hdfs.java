...
public class Hdfs extends AbstractFileSystem
{
     ...
     */
    abstract private class DirListingIterator<T extends FileStatus> implements RemoteIterator<T>
    {
    ...
    public long renewDelegationToken(Token<? extends AbstractDelegationTokenIdentifier> token) throws InvalidToken, IOException
    {
     ...
     */
    @SuppressWarnings("unchecked")
    public void cancelDelegationToken(Token<? extends AbstractDelegationTokenIdentifier> token) throws InvalidToken, IOException
    {
