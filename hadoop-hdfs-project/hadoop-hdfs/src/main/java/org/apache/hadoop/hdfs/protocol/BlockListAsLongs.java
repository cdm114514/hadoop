...
public abstract class BlockListAsLongs implements Iterable<BlockReportReplica>
{
     ...
     */
    public static BlockListAsLongs decodeBuffer(final int numBlocks, final ByteString blocksBuf)
    {
     ...
     * @return BlockListAsLongs
     */
    public static BlockListAsLongs encode(final Collection<? extends Replica> replicas)
    {
    ...
    private static class BufferDecoder extends BlockListAsLongs
    {
        ...
        BufferDecoder(final int numBlocks, final int numFinalized, final ByteString buf)
        {
