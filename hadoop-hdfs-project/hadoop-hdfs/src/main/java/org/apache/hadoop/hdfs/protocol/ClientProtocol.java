...
public interface ClientProtocol
{
     ...
     */
    @AtMostOnce
    public LastBlockWithStatus append(String src, String clientName, EnumSetWritable<CreateFlag> flag) throws AccessControlException, DSQuotaExceededException, FileNotFoundException, SafeModeException, UnresolvedLinkException, SnapshotAccessControlException, IOException;
     ...
     */
    @Idempotent
    public boolean truncate(String src, long newLength, String clientName) throws AccessControlException, FileNotFoundException, SafeModeException, UnresolvedLinkException, SnapshotAccessControlException, IOException;
     ...
     * and a cookie
     * @throws IOException Each call returns a subset of the corrupt files in the system. To obtain
     ...
     */
    @Idempotent
    public void setQuota(String path, long namespaceQuota, long storagespaceQuota, StorageType type) throws AccessControlException, FileNotFoundException, UnresolvedLinkException, SnapshotAccessControlException, IOException;
     ...
     *
     * @param snapshotRoot full path of the directory where snapshots are taken
     * @param fromSnapshot snapshot name of the from point. Null indicates the current
     *                     tree
     * @param toSnapshot   snapshot name of the to point. Null indicates the current
     *                     tree.
     ...
     *
     * @param req The request to modify a cache pool.
     * @throws IOException If the request could not be completed.
     */
    @AtMostOnce
