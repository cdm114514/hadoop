...
public class SnapshotDiffReport
{
    ...
    {
        CREATE("+"), MODIFY("M"), DELETE("-"), RENAME("R");
    ...
    public SnapshotDiffReport(String snapshotRoot, String fromSnapshot, String toSnapshot, List<DiffReportEntry> entryList)
    {
        ...
        this.diffList = entryList != null ? entryList : Collections.<DiffReportEntry>emptyList();
    }
    ...
    public String toString()
    {
        ...
        str.append("Difference between " + from + " and " + to + " under directory " + snapshotRoot + ":" + LINE_SEPARATOR);
