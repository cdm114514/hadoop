...
public class SnapshottableDirectoryStatus
{
    ...
    {
        this.dirStatus = new HdfsFileStatus(0, true, 0, 0, modification_time, access_time, permission, owner, group, null, localName, inodeId, childrenNum, null, BlockStoragePolicySuite.ID_UNSPECIFIED);
    ...
    {
        String parentFullPathStr = (parentFullPath == null || parentFullPath.length == 0) ? null : DFSUtil.bytes2String(parentFullPath);
