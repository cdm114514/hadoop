...
class SaslParticipant
{
    ...
    {
        return new SaslParticipant(Sasl.createSaslServer(MECHANISM, PROTOCOL, SERVER_NAME, saslProps, callbackHandler));
    }
    ...
    {
        return new SaslParticipant(Sasl.createSaslClient(new String[]{MECHANISM}, userName, PROTOCOL, SERVER_NAME, saslProps, callbackHandler));
    }
