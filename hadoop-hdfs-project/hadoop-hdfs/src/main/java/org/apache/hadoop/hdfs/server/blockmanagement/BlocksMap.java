...
class BlocksMap
{
    private static class StorageIterator implements Iterator<DatanodeStorageInfo>
    {
        ...
        {
            return blockInfo != null && nextIdx < blockInfo.getCapacity() && blockInfo.getDatanode(nextIdx) != null;
        }
    ...
    BlockInfoContiguous replaceBlock(BlockInfoContiguous newBlock)
    {
        ...
        for (int i = currentBlock.numNodes() - 1; i >= 0; i--)
        {
            ...
            Preconditions.checkState(result == AddBlockResult.ADDED, "newBlock already exists.");
        }
