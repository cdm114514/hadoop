...
public class DatanodeDescriptor extends DatanodeInfo
{
    ...
    public static class CachedBlocksList extends IntrusiveCollection<CachedBlock>
    {
        public enum Type
        {
            PENDING_CACHED, CACHED, PENDING_UNCACHED
        }
     ...
     */
    private final BlockQueue<BlockInfoContiguousUnderConstruction> recoverBlocks = new BlockQueue<BlockInfoContiguousUnderConstruction>();
    /**
    ...
    static final private List<DatanodeStorageInfo> EMPTY_STORAGE_INFO_LIST = ImmutableList.of();
    ...
    List<DatanodeStorageInfo> removeZombieStorages()
    {
        ...
        synchronized (storageMap)
        {
            ...
            while (iter.hasNext())
            {
                ...
                {
                    LOG.info(storageInfo.getStorageID() + " had lastBlockReportId 0x" + Long.toHexString(storageInfo.getLastBlockReportId()) + ", but curBlockReportId = 0x" + Long.toHexString(curBlockReportId));
                    iter.remove();
                    if (zombies == null)
                    {
