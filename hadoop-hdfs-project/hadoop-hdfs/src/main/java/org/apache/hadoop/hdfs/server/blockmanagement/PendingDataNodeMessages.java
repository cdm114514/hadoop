...
class PendingDataNodeMessages
{
    ...
    static class ReportedBlockInfo
    {
        ...
        ReportedBlockInfo(DatanodeStorageInfo storageInfo, Block block, ReplicaState reportedState)
        {
        ...
        {
            return "ReportedBlockInfo [block=" + block + ", dn=" + storageInfo.getDatanodeDescriptor() + ", reportedState=" + reportedState + "]";
        }
    }
    ...
    void enqueueReportedBlock(DatanodeStorageInfo storageInfo, Block block, ReplicaState reportedState)
    {
        block = new Block(block);
        getBlockQueue(block).add(new ReportedBlockInfo(storageInfo, block, reportedState));
        count++;
    }
