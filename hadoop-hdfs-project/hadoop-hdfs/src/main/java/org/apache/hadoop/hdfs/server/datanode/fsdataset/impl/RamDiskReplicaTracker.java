...
public abstract class RamDiskReplicaTracker
{
    ...
    static class RamDiskReplica implements Comparable<RamDiskReplica>
    {
        ...
        RamDiskReplica(final String bpid, final long blockId, final FsVolumeImpl ramDiskVolume)
        {
            this.bpid = bpid;
     ...
     */
    abstract void addReplica(final String bpid, final long blockId, final FsVolumeImpl transientVolume);
