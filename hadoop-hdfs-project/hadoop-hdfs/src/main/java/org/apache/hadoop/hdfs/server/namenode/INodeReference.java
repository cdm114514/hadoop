...
public abstract class INodeReference extends INode
{
    ...
    public QuotaCounts cleanSubtree(BlockStoragePolicySuite bsps, int snapshot, int prior, BlocksMapUpdateInfo collectedBlocks, final List<INode> removedINodes)
    {
    ...
    public static class WithCount extends INodeReference
    {
        ...
        {
            return withNameList.size() > 0 ? withNameList.get(withNameList.size() - 1) : null;
        }
        ...
        public INodeReference getParentRef(int snapshotId)
        {
            ...
            if (start < withNameList.size() && withNameList.get(start).lastSnapshotId >= snapshotId)
            {
    ...
    public static class WithName extends INodeReference
    {
        ...
        public final ContentSummaryComputationContext computeContentSummary(ContentSummaryComputationContext summary)
        {
            ...
            computeQuotaUsage(summary.getBlockStoragePolicySuite(), getStoragePolicyID(), q, false, lastSnapshotId);
        ...
        @Override
        public QuotaCounts cleanSubtree(BlockStoragePolicySuite bsps, final int snapshot, int prior, final BlocksMapUpdateInfo collectedBlocks, final List<INode> removedINodes)
        {
    ...
    public static class DstReference extends INodeReference
    {
        ...
        @Override
        public QuotaCounts cleanSubtree(BlockStoragePolicySuite bsps, int snapshot, int prior, BlocksMapUpdateInfo collectedBlocks, List<INode> removedINodes)
        {
