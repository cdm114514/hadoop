...
public class INodeSymlink extends INodeWithAdditionalFields
{
    ...
    @Override
    public QuotaCounts cleanSubtree(BlockStoragePolicySuite bsps, final int snapshotId, int priorSnapshotId, final BlocksMapUpdateInfo collectedBlocks, final List<INode> removedINodes)
    {
    ...
    @Override
    public ContentSummaryComputationContext computeContentSummary(final ContentSummaryComputationContext summary)
    {
     ...
     * symlinks.
     *
     * @Override final AclFeature getAclFeature(int snapshotId) {
