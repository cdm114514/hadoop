...
public class FileDiffList extends AbstractINodeDiffList<INodeFile, INodeFileAttributes, FileDiff>
{
    ...
    {
        final FileDiff diff = super.saveSelf2Snapshot(latestSnapshotId, iNodeFile, snapshotCopy);
     ...
     */
    void combineAndCollectSnapshotBlocks(BlockStoragePolicySuite bsps, INodeFile file, FileDiff removed, BlocksMapUpdateInfo collectedBlocks, List<INode> removedINodes)
    {
        ...
        BlockInfoContiguous[] earlierBlocks = (earlierDiff == null ? new BlockInfoContiguous[]{} : earlierDiff.getBlocks());
