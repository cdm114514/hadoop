...
public class Step implements Comparable<Step>
{
    ...
    public int compareTo(Step other)
    {
        ...
        return new CompareToBuilder().append(file, other.file).append(sequenceNumber, other.sequenceNumber).toComparison();
    }
    ...
    public boolean equals(Object otherObj)
    {
        ...
        return new EqualsBuilder().append(this.file, other.file).append(this.size, other.size).append(this.type, other.type).isEquals();
    }
