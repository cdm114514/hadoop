...
public class NamespaceInfo extends StorageInfo
{
    ...
    {
        UNKNOWN(false), STORAGE_BLOCK_REPORT_BUFFERS(true); // use optimized ByteString buffers
    ...
    {
        super(HdfsConstants.NAMENODE_LAYOUT_VERSION, nsID, clusterID, cT, NodeType.NAME_NODE);
        blockPoolID = bpID;
