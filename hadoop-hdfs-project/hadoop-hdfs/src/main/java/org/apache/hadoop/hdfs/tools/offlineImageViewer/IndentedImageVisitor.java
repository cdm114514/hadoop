...
class IndentedImageVisitor extends TextWriterImageVisitor
{
    ...
    {
        if ((element == ImageElement.DELEGATION_TOKEN_IDENTIFIER_EXPIRY_TIME) || (element == ImageElement.DELEGATION_TOKEN_IDENTIFIER_ISSUE_DATE) || (element == ImageElement.DELEGATION_TOKEN_IDENTIFIER_MAX_DATE))
        {
