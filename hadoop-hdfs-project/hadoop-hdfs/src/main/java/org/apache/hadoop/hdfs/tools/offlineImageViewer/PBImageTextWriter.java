...
abstract class PBImageTextWriter implements Closeable
{
    ...
    private static class InMemoryMetadataDB implements MetadataMap
    {
        ...
        public String getParentPath(long inode) throws IOException
        {
            ...
            Preconditions.checkState(parent != null, "Can not find parent directory for INode: %s", inode);
    ...
    private static class LevelDBMetadataMap implements MetadataMap
    {
        ...
        public void putDir(INode dir) throws IOException
        {
            Preconditions.checkArgument(dir.hasDirectory(), "INode %s (%s) is not a directory.", dir.getId(), dir.getName());
    ...
    private void loadINodeDirSection(FileInputStream fin, List<FileSummary.Section> sections, FileSummary summary, Configuration conf) throws IOException
    {
